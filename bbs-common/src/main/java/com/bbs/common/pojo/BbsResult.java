...
public class BbsResult {
    ...
    public static BbsResult build(Integer status, String msg, Object data) {
        return new BbsResult(status, msg, data);
    }
    ...
    public static BbsResult build(Integer status, String msg) {
        return new BbsResult(status, msg, null);
    }

    public BbsResult(Integer status, String msg, Object data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }
